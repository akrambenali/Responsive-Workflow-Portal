...
@Component(
  {
    selector: 'app-tasklist-in-pending',
    templateUrl: './tasklist-in-pending.component.html',
    styleUrls: ['./tasklist-in-pending.component.scss'],
    providers: [TaskService, DecimalPipe]
  })

export class TasklistInPendingComponent {
